                ...
                if ein.lower()=='s':
                    ...
                    while True:
                        ...
                        if len(pi.split(':'))==2:
                            ...
                            break
                        elif pi.isascii() and pi.lower()!='e':
                    ...
                    while True:
                        ...
                        if ein.lower()=='s':
                            ...
                            if len(pi.split(':'))==2:
                                ...
                                se=spword[1]
                                if  se.isascii():
                                 sp1=gTTS(text=spword[1],slow=False,lang='ar')
                                 sp2=gTTS(text=spword[0],slow=False)
                                 sp1.save('text1.mp3')
                                 sp2.save('text2.mp3')
                                 make('text1.mp3')
                                 make('text2.mp3')
             ...
             if ink not in wana:
                 ...
                 for i in range(0,10):
                     ...
                     if nu==0:
                         ...
                         nuw=i
                         if i =='A':
                                 choi.append(f'B-{laword[0]}')
                                 choi.append(f'C-{laword[1]}')
                                 choi.append(f'D-{laword[2]}')
                                 ac=True
                                 bc=False
                                 cc=False
                                 dc=False
